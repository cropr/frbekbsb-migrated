...
// Entete de la page
//------------------
	WriteFRBE_Header("Noms en double dans signal�tique");
...
<?php  
	$sql1 = "SELECT Matricule, signaletique.Nom, Prenom, Club, Dnaiss, AnneeAffilie,DateInscription,DateAffiliation,LoginModif," .
...
?>
	<table border=1>
		...
		<tr><th>Matricule</th><th>Nom</th><th>Prenom</th><TH>Club</th><th>Dnaiss</th><th>Soundex</th><th>Affil</th><th>DatIns</th><th>DatAff</th><th>LogModif</th></tr>
