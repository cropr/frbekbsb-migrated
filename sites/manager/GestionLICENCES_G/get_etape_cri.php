...
if ($id_etape > 0) {
    $sql = "SELECT * FROM j_etapes_cri WHERE id_etape = " . $id_etape . " ORDER BY date_etape";
} else {
    //$sql = "SELECT * FROM j_etapes_cri ORDER BY date_etape";
    $sql = "SELECT * FROM j_etapes_cri WHERE date_etape IS NOT NULL ORDER BY date_etape;";
}
