...
$sql_etapes = "SELECT * FROM j_etapes_cri WHERE date_etape IS NOT NULL ORDER BY date_etape;";
...
<head>
    ...
    <title>Etapes Vlaams Jeugdschaakcriterium</title>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    <link rel="stylesheet" href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/themes/smoothness/jquery-ui.css">
    <script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>

    <script src="etapes_cri.js"></script>
...
<div id="etapes_jef" class="div_conteneur_form">
    ...
    <div id="detail_etape_cri" class="div_conteneur_form">
        <fieldset>
            <legend><h4><?php echo langue("Détails étape criterium", "Details circuit criterium"); ?></h4></legend>
            ...
            <p>
                ...
                <input id="form_date_etape" type="text" size="10" maxlength="10" "
                pattern="[1-2][0129][0-9][0-9]-[0-1][0-9]-[0-3][0-9]">(**)
            </p>
            <p>
                <label for="form_local_etape"><?php echo Langue("Local", "Lokaal"); ?></label>
                <input id="form_local_etape" type="text" size="30" maxlength="64">
            </p>
            <p>
                <label for="form_adresse_etape"><?php echo Langue("Adresse", "Adres"); ?></label>
                <input id="form_adresse_etape" type="text" size="30" maxlength="48">
            </p>
            <p>
            ...
            <p>
                ...
                <input id="form_localite_etape" type="text" size="30" maxlength="48">
            </p>
            <p>
            ...
            <p>
                ...
                <input id="form_email_org_etape" type="email" size="30" maxlength="48">
            </p>
            <p>
                <label
                        for="form_telephone_org_etape"><?php echo Langue("Tél. organisateur", "Tel. organisator"); ?></label>
                <input id="form_telephone_org_etape" type="text" size="30" maxlength="24">
            </p>
            <p>
    ...
    <div id="liste_etapes_cri" class="div_conteneur_form">
        <fieldset>
            ...
            <table id="table_liste_etapes">
                ...
                while ($result_etapes = mysqli_fetch_assoc($sth_etapes)) {
                    if ($result_etapes['date_etape'] <> '0000-00-00') {
                        $etp++;
                    }
                    $website = "";
                    $note_t = "";
                    ...
                    if ($result_etapes['date_etape'] <> '0000-00-00') {
                        ...
                        echo "<td align = 'center' name = 'date_" . $etp . "' >" . $result_etapes['date_etape'] . "</td>";
        ...
        <fieldset>
            <div id="boutons">
                ...
                <button id="form_bt_actualiser" name="form_bt_actualiser"
                        title="<?php echo Langue("Actualiser les numéros d'étapes suite à une modification de dates", "Vernieuw de nummers van de stappen na een wijziging data"); ?>">
                    <img id="chargement" src="images/actualiser.png" alt="Actualiser"/>
                </button>
            </div>
        </fieldset
    </div>
