...
$(function () {
    ...
    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    // Actualise la liste des étapes après modification
    // ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

    $("#form_bt_actualiser").on("click", function () {
        window.location = "etapes_cri.php";
    });
...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    $("#form_bt_sauvegarder").on("click", function () {
        ...
        if (!nom_org_etape) {
            //MessageAlerte += "Nom organisteur étape obligatoire!<br>";
        }
        if (!email_org_etape) {
            //MessageAlerte += "Email organisteur étape obligatoire!<br>";
        }
        ...
        ajax_add_etape_cri(id_etape, numero_etape, date_etape, local_etape, adresse_etape, cp_etape, localite_etape, nom_org_etape,
...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
// récup and display etapes cri
function ajax_get_etape(id_etape, numero_etape) {
    $.ajax({
        url: "get_etape_cri.php",
        data: {
            id_etape: id_etape,
...
function ajax_add_etape_cri(id_etape, numero_etape, date_etape, local_etape, adresse_etape, cp_etape, localite_etape, nom_org_etape,
                            email_org_etape, gsm_org_etape, telephone_org_etape, website, note) {
    $.ajax({
        url: "add_etape_cri.php",
        data: {
            id_etape: id_etape,
            numero_etape: numero_etape,
