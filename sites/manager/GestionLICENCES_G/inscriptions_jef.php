...
if ($_SESSION['id_manager'] > 0) {
    // Liste des joueurs licence G & affiliés à la fédaration en vue de leur inscription au JEF
...
<div id="fiche_detail" class="div_conteneur_form" hidden>
    <fieldset>
        <p>
            ...
            <label for="form_nom_jr_jef"><?php echo Langue("Nom Prénom", "Naam Voornaam"); ?></label>
...
<div class="div_conteneur_form">
    <fieldset>
        ...
        <p>
            <label for="form_filtre_jr_jef"><?php echo Langue("Filtrer sur le n° d'étape", "Filter op het circuitnr."); ?></label>
